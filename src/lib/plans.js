...
export const PLANS = [
  {
    ...
    features: {
      es: [
        ...
        "Define tus horarios, días libres y pausas de almuerzo",
        "Los pacientes solo ven tus horarios realmente disponibles",
        "Sala de espera con sistema de turnos",
        "Recordatorios automáticos por WhatsApp (100/mes)",
        "Ficha básica del paciente e historial de visitas",
        "Prueba gratis de 14 días y soporte por email",
      ],
      en: [
        "Online appointment booking (up to 2 doctors)",
        "Set your own hours, days off, and lunch breaks",
        "Patients only see your real available slots",
        "Waiting room queue and patient turn system",
        "Automatic WhatsApp reminders (100/month)",
        "Basic patient file and visit history",
        "14-day free trial, email support",
      ],
    },
  },
  {
    ...
    features: {
      es: [
        "Todo lo de Starter más todas las funciones de ficha del paciente",
        "Múltiples sucursales, cada una con su propio horario",
        "Disponibilidad personalizada por doctor: turnos partidos, horarios por temporada y excepciones",
        "Reglas de reserva: tiempo de aviso, margen entre citas y límites de capacidad",
        "Los pacientes reservan en línea y siempre ven la disponibilidad actualizada",
      ...
      en: [
        "Everything in Starter plus all patient file features",
        "Multiple clinic locations, each with their own schedule",
        "Custom availability per doctor — split shifts, burst schedules, exceptions",
        "Booking rules — notice periods, buffer time between visits, capacity limits",
        "Patients book online and always see up-to-date availability",
